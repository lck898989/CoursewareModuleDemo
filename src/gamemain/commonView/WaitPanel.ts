...
class WaitPanel extends egret.Sprite {
    ...
    // private imgBgRect:egret.Bitmap;   // 底部方框
    private imgBgBall: egret.Bitmap;   // 底部球
    private imgFontLoading: egret.Bitmap;  // 加载中文字
    ...
    private createView(): void {
        ...
        this.addGroupCont(this.imgBgBall, "bg_ball_png");
        this.addGroupCont(this.imgFontLoading, "font_loading_png");
    ...
    private addGroupCont(img: egret.Bitmap, res: string): void {
