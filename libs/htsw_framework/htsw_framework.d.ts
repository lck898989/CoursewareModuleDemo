...
declare class App {
     ...
     * @constructor
     */
    static readonly VideoTools: VideoTools;
    /**
     * 初始化函数
     * @constructor
     */
...
declare class BaseDefines {
    ...
    static FrameworkVersion: string;
}
/**
 * 背景音乐类
 */
...
declare class VideoTools {
     ...
     */
    referenceVideoJs(): void;
    /**
     * 播放m3u8视频用原生js video标签
     */
    videoTools_playM3u8(videoId: string, width: number, height: number, videoUrl: string, bAuto?: boolean): void;
    /**
     * 移除video标签
     */
    deleteVideoLab(videoId: string): void;
    static readonly instance: VideoTools;
}
/**
 * 闪烁特效类
 */
